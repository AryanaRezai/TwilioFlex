$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/com/realpage/components/FlexMyProfilePage/flexmyprofilepage.feature");
formatter.feature({
  "line": 1,
...
formatter.step({
  "line": 12,
  "name": "Agent navigates to My Profile Page",
  "keyword": "And "
});
formatter.step({
  "line": 13,
...
formatter.step({
  ...
  "keyword": "When "
=======
  "name": "Agent sees the agents info",
  "keyword": "And "
>>>>>>> Stashed changes
});
formatter.match({
