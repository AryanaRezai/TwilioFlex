package com.realpage.ui.WidgetCheckOnlyUat;
 ...
 *******************************************************
 */
public class WidgetCheckOnlyUatStepDefinitions extends PageBase{
	 ...
	 */
	@Autowired
	public WidgetCheckOnlyUatStepDefinitions(WebDriverManager webDriver, DataManager data) {
	...
	@When("^A chat preview is displayed in uat$")
	...
	@When("^Call To Action Text is there in uat$")
	public void Call_To_Action_Text_is_there_in_uat() throws Throwable {
		try{
	...
	@When("^Greeting Text is there in uat$")
	public void Greeting_Text_is_there_in_uat() throws Throwable {
		try{
	...
	@When("^Prechat questions are there in uat$")
	public void Prechat_questions_are_there_in_uat() throws Throwable {
		try{
			
			Actions actions = new Actions(driver);
			actions.moveToElement(driver.findElement(By.cssSelector("#widgetDetail > div.widget-details-subjects > div:nth-child(2) > div > div:nth-child(1) > div.raul-box-header > h3")));
			actions.perform();
			Thread.sleep(1000);
			
			WebElement leasetoggle= driver.findElement(By.cssSelector("#widgetDetail > div.widget-details-subjects > div:nth-child(2) > div > div:nth-child(1) > div.raul-box-block.px-3.py-3 > label > div > span"));
		    
			
			
			//Text Messages check box
			WebElement textcheckbox = driver.findElement(By.cssSelector("#widgetDetail > div.widget-details-subjects > div:nth-child(2) > div > div:nth-child(1) > div.raul-box-block.px-3.py-3 > div > div:nth-child(1) > div > label:nth-child(3) > span.raul-form-input-text"));
...
//	     }
	...
	public void User_navigates_to_Appearance_in_uat() throws Throwable {
		try{
	...
	@Then("^there is a Text color field in uat$")
	public void there_is_a_Text_color_field_in_uat() throws Throwable {
		try{
	...
	@Then("^there is a Header and Button color field in uat$")
	public void there_is_a_Header_and_Button_color_field_in_uat() throws Throwable {
		try{
	...
	@When("^The header text is matching in uat$")
	public void The_header_text_is_matching_in_uat() throws Throwable {
		try{
	...
	public void User_clicks_on_the_widget_in_uat() throws InterruptedException {
		try {
...
//	
	...
	@When("^The text color is matching in uat$")
	public void The_text_color_is_matching_in_uat() throws Throwable {
		try{
	...
	@When("^The header and button color is matching in uat$")
	public void The_header_and_button_is_matching_in_uat() throws Throwable {
		try{
